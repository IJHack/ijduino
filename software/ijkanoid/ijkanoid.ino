...
*
*
*  Based on pong code from 
*  http://www.itopen.it/2012/03/09/arduino-pong-with-8x8-led-matrix-and-max7219/
*
*/
...
void setSprite(const byte *sprite){
    for(int r = 0; r < 8; r++){
